const svc = require('../../services/nakjm/projects.service');
...
exports.analytics = async (req, res, next) => { try { res.json(await svc.analytics(req.params.id, req)); } catch (e) { next(e); } };
