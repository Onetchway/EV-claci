...
function buildStageHtml({ client, project, stageTemplate, submission, photos, photoFileUrls }) {
...
<body>
  ...
  <div class="footer">Generated by NaKJM Infra Field App · Confidential — for ${escapeHtml(client.name)} project execution records only.</div>
</body>
</html>`;
}
