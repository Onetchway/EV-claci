...
import {
  BarChart3, Battery, Boxes, Briefcase, Building2, CalendarCheck, CalendarClock, CalendarDays, ChevronDown, ClipboardList, FileClock, FileSignature, FileSpreadsheet, FileText,
...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/boq", label: "BOQ", icon: ClipboardList, featureKey: "boq" },
      { href: "/vendors", label: "Vendor Management", icon: Truck, featureKey: "vendors" },
      { href: "/vendor-assignments", label: "Vendor Assignments", icon: Briefcase, featureKey: "vendor_assignments" },
