      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <Card title="Details" className="lg:col-span-2">
          <dl className="grid gap-3 sm:grid-cols-2">
            ...
            <div><dt className="text-xs uppercase tracking-wide text-ink-500">Purchase order</dt><dd className="mt-0.5 text-sm">{asset.poNumber ? <Link href={`/purchase-orders/${asset.poId}`} className="text-brand-700 hover:underline">{asset.poNumber}</Link> : "—"}</dd></div>
            <div><dt className="text-xs uppercase tracking-wide text-ink-500">Project / station</dt><dd className="mt-0.5 text-sm">{asset.linkedProjectCode || "—"}</dd></div>
