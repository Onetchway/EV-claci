  ...
  return (
    <>
      ...
      <Modal
        ...
        title="Add a user"
        description="An account is created in Firebase Auth and a CRM profile is written with the chosen role. Set their designation, department and reporting manager afterwards from HRMS → Employees."
        footer={
          <>
        ...
        {editing && (
          <div className="space-y-4">
            ...
            <p className="text-xs text-ink-500">
              Designation, department and reporting manager are set from HRMS → Employees.
            </p>
