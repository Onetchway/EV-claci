...
export const AGREEMENT_RECITALS = [
  "{{company}} is engaged in the business of installation, operation, and management of Electric Vehicle (EV) charging infrastructure across India under a Franchisee-Owned, Company-Operated (“FOCO”) model, whereby the Franchisee owns the Charging Station equipment and {{company}} installs, operates, and manages the same, while the Franchisee provides access to the premises.",
...
export const AGREEMENT_CLAUSES: AgreementClause[] = [
  {
    number: "1", heading: "DEFINITIONS", paragraphs: [
      ...
      "1.2 “Charging Station” means the EV charging equipment of [CHARGER TYPE & CAPACITY] installed by {{company}} at the Site, together with all associated civil works, canopy, cabling, metering infrastructure, and related equipment.",
      "1.3 “Charging Management System / CMS” means {{company}}’s OCPP-compliant Central Management System used for real-time monitoring, metering, billing, and remote management of all charging sessions at the Site.",
      ...
      "1.6 “{{company}} Fee” means {{company}}’s operational service and management fee per unit (kWh) dispensed at the Charging Station, as specified in Schedule I, metered transparently through the CMS.",
      "1.7 “Minimum Assured Amount” means the minimum monthly amount payable by {{company}} to the Franchisee per Charging Point, as specified in Schedule I, for the Payout Period.",
      ...
      "1.9 “Public Selling Rate” means the rate per unit (kWh) charged to end-users at the Charging Station, as specified in Schedule I, subject to revision by {{company}} from time to time in accordance with Clause 5.4.",
      ...
      "1.14 “Exit Notice” means the written notice issued by the Franchisee to {{company}} under Clause 14, evidencing the Franchisee’s intention to exit this Agreement and exercise the Buyback Option.",
    ],
  },
  {
    number: "2", heading: "GRANT OF FRANCHISE", paragraphs: [
      "2.1 Subject to the terms of this Agreement, {{company}} hereby grants to the Franchisee a non-exclusive, non-transferable, site-specific right to host the Charging Station at the Site for the duration of the Tenure, in consideration of the commercial arrangement set out in Clause 5 and Schedule I.",
      "2.2 The franchise granted hereunder is strictly limited to the Site specified in Schedule I. The Franchisee shall have no right to sub-license, assign, or otherwise transfer any rights conferred under this Agreement to any third party without {{company}}’s prior written consent.",
      "2.3 The Franchisee shall own the Charging Station equipment (including the charger unit, canopy, cabling, and associated civil and electrical infrastructure) at all times, both during and after the Tenure, subject to Clause 13.4 and the Buyback and removal provisions of this Agreement. For the avoidance of doubt, ownership of the {{company}}/CMS platform, software, and all associated intellectual property, including the {{company}} brand, name, and marks, shall at all times remain vested solely in {{company}}, and no title thereto shall pass to the Franchisee at any point during or after the Tenure.",
      "2.4 The grant of franchise hereunder does not confer any territorial exclusivity or right of first refusal in respect of other charging station opportunities of {{company}}, except where expressly agreed in writing.",
    ],
  },
  {
  ...
  },
  {
    number: "4", heading: "CHARGING STATION AND SITE DETAILS", paragraphs: [
      ...
      "4.2 {{company}} shall be responsible for the procurement, installation, and commissioning of the Charging Station, including all associated electrical infrastructure and DISCOM liaison, in accordance with applicable law.",
      "4.3 The Site is subject to feasibility and regulatory approval. {{company}} may substitute the exact location of the Charging Station within the Site if the originally identified spot becomes unviable; this shall not be treated as a breach of this Agreement. If an alternate location is not offered by {{company}} within a maximum of 30 days, or if the Franchisee is not satisfied with the alternate location, any money already received by {{company}} from the Franchisee shall be immediately refunded to the Franchisee on demand.",
    ],
  },
  {
    number: "5", heading: "COMMERCIAL TERMS AND PAYMENT", paragraphs: [
      ...
      "5.4 {{company}} shall be entitled to deduct the {{company}} Fee per kWh, as specified in Schedule I, towards software usage, backend services, operation, and management. {{company}} may revise the Public Selling Rate.",
  ...
  },
  {
    number: "8", heading: "BRANDING, LOGO DISPLAY, AND PRIMARY LOCATION PARTNER RECOGNITION", paragraphs: [
      ...
      "8.2 The Franchisee shall be recognised as the Primary Location Partner. {{company}} may display its own branding on the Charging Station and related platforms; such display shall not restrict or prevent the Franchisee.",
    ],
  },
  {
    number: "9", heading: "DATA TRANSPARENCY AND REPORTING", paragraphs: [
      "9.1 {{company}} shall provide the Franchisee with monthly operational and financial reports relating to the Charging Station, including total electricity consumption (kWh), total revenue generated, {{company}} Fee deductions, and the net payable amount, to ensure transparency and mutual understanding of the Charging Station’s performance.",
    ],
  },
  {
  ...
  },
  {
    number: "11", heading: "INDEMNITY AND LIABILITY", paragraphs: [
      "11.1 {{company}} shall be solely responsible for ensuring that the Charging Station complies with all applicable electrical, technical, and statutory safety standards, and for obtaining all necessary approvals, permits, and regulatory compliances.",
      ...
      "11.3 Each Party (“Indemnifying Party”) shall indemnify, defend and hold harmless the other Party, its directors, officers, employees and representatives (“Indemnified Party”) from and against any losses, damages, liabilities, claims, costs and expenses (including reasonable legal fees) arising out of or in connection with: (i) any breach of this Agreement by the Indemnifying Party; (ii) any misrepresentation, negligence or wilful misconduct of the Indemnifying Party; or (iii) any third-party claim attributable to the Indemnifying Party's acts, omissions, or obligations under this Agreement, including, in the case of the Franchisee, claims relating to the Site or access thereto, and in the case of {{company}}, claims relating to its services, operations, or obligations under this Agreement. Except for liability arising under Clause 5 (Confidentiality), fraud, wilful misconduct, gross negligence, or the indemnity obligations under this Agreement, each Party's aggregate liability under this Agreement shall not exceed the aggregate amounts paid or payable by {{company}} to the Franchisee under Schedule I. In no event shall either Party be liable to the other for any indirect, incidental, special, exemplary, punitive, or consequential damages, including loss of profits, revenue, goodwill, or business opportunity, whether arising in contract, tort, or otherwise.",
    ],
  },
  {
    number: "12", heading: "DEFAULT AND NON-PAYMENT", paragraphs: [
      "12.1 Timely payment of the Minimum Assured Amount forms an essential part of this Agreement. In the event {{company}} fails to make agreed payments for two (2) consecutive months, the Franchisee reserves the right to issue written notice and seek resolution through mutual discussion, and thereafter to pursue such other remedies as may be available in law, subject to Clause 13.",
      "12.2 Similarly, persistent failure by {{company}} to maintain the Charging Station in accordance with the uptime and maintenance standard under Clause 6.3, continuing for a period of thirty (30) days or more after written notice from the Franchisee specifying the default, shall constitute a material breach entitling the Franchisee to the remedies set out in Clause 13.3.",
    ],
  },
  {
    number: "13", heading: "TERMINATION", paragraphs: [
      ...
      "13.2 {{company}} may terminate this Agreement immediately on written notice if the Franchisee breaches a material term hereof and fails to remedy such breach within fifteen (15) days of notice, or denies access to the Site without valid cause.",
      "13.3 The Franchisee may terminate this Agreement by written notice to {{company}} if {{company}}: (a) fails to pay the Minimum Assured Amount for two (2) or more consecutive months in breach of Clause 12.1; or (b) commits a material and continuing breach of the uptime and maintenance standard under Clause 6.3, as set out in Clause 12.2; and, in either case, fails to remedy such default within thirty (30) days of written notice from the Franchisee specifying the default. On such termination, the Franchisee shall, in addition, be entitled to pursue such remedies as may be available in law for recovery of amounts due.",
      "13.4 On termination or expiry of this Agreement (other than pursuant to exercise of the Buyback Option under Clause 14), {{company}} shall be entitled to remove the Charging Station equipment from the Site within a reasonable period, and the Franchisee shall provide reasonable access for such removal. Provisions relating to confidentiality, indemnity, and liability shall survive termination.",
    ],
  },
  {
    number: "14", heading: "EXIT OPTION AND BUYBACK OF CHARGING STATION", paragraphs: [
      ...
      "14.5 Save as expressly provided in this Clause 14, the Franchisee shall have no right to purchase or otherwise acquire title to the Charging Station equipment or any other asset of {{company}} at the Site under any other provision of this Agreement.",
    ],
  },
  {
