...
import {
  Avatar, Button, EmptyState, Field, Input, Modal, PageHeader, Select, Spinner, StatCard, useAsyncAction,
} from "@/components/ui";
                ...
                return (
                  <tr key={u.id} className="hover:bg-ink-50">
                    ...
                    <td className="td text-right">
                      {canEdit && (
                        <button onClick={() => setEditing(u)} className="rounded px-2 py-1 text-xs font-medium text-brand-700 hover:bg-brand-50">
                          Manage
                        </button>
                      )}
                    </td>
