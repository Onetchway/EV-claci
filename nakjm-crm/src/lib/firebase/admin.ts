 ...
 * creating users, minting role custom-claims, and deleting/disabling
 * accounts.
 *
 ...
 *     App Hosting / Cloud Run, where a service account is already attached
 *     to the instance.
 */

const APP_NAME = "nakjm-crm-admin";
