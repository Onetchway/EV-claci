...
const PINS = [
  { x: 97.0, y: 106.0, label: 'Delhi NCR', anchor: 'end', dx: -9, dy: 3 },
  { x: 132.9, y: 122.3, label: 'Lucknow', anchor: 'start', dx: 9, dy: 3 },
  { x: 105.7, y: 90.1, label: 'Dehradun', anchor: 'end', dx: -9, dy: 3 },
];
            ...
            {PINS.map((p, i) => (
              <g key={p.label}>
                ...
                <text
                  ...
                  style={{ fontSize: 10, fontWeight: 700, fill: '#0F2A4A' }}
                >
                  {p.label}
                </text>
              </g>
