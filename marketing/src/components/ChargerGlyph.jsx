  ...
  return (
    <div className="relative flex h-full w-full items-center justify-center">
      <motion.div
        ...
        style={{
          background: `radial-gradient(circle, rgba(111,219,146,${0.25 + intensity * 0.35}), transparent 70%)`,
        }}
      />
      <svg width="220" height="320" viewBox="0 0 220 320" fill="none" className="relative">
        ...
        <rect x="58" y="56" width="104" height="72" rx="10" fill="#071A35" stroke="#20A84A" strokeOpacity="0.5" />
        <motion.text
          x="110"
          y="100"
          textAnchor="middle"
        ...
        <circle cx="90" cy="160" r="7" fill="#20A84A" />
        {connectors > 1 && <circle cx="130" cy="160" r="7" fill="#20A84A" />}
        ...
        <path
          ...
          opacity="0.8"
        />
        <circle cx="212" cy="234" r="6" fill="#6FDB92" />
      </svg>
    </div>
  );
}
