...
-- existing feature set, minus anything CMS-related).
-- ============================================================
INSERT INTO feature_catalog (key, name, description, category, is_default_enabled) VALUES
    ...
    ('clients',       'Clients',            'Client relationship management',         'crm',        true),
    ('vendors',       'Vendors',            'Vendor management',                      'crm',        true),
    ('projects',      'Projects',           'Project management',                     'crm',        true),
    ('quotations',    'Quotations & BOQ',   'Quotation and bill-of-quantities',       'crm',        true),
    ('purchase_orders','Purchase Orders',   'PO and proforma invoice management',     'crm',        true),
    ('payments',      'Payments',           'Client and vendor payment tracking',     'finance',    true),
    ('documents',     'Documents',          'Document storage per client/project',    'crm',        true),
    ('site_reports',  'Site Reports',       'Progress photos and site reporting',     'crm',        true),
    ('leave_requests','Leave Management',   'Employee leave requests and approval',   'hr',         true),
    ('users',         'Team & Users',       'Team member management and roles',       'admin',      true)
